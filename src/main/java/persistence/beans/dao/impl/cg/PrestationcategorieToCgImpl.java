 ...
 */
@DBTableInfos(name="prestationcategorie",daoClass=PrestationcategorieDaoCgImpl.class)
public class PrestationcategorieToCgImpl implements persistence.beans.dao.IPrestationcategorieTo, java.io.Serializable {
	
	/**
	 * serialVersionUID genere d'apres le nom de la classe
	 */
	private static final long serialVersionUID = 18215L;
	
	private transient PrestationcategorieDaoCgImpl _dao=null;
	protected PrestationcategorieDaoCgImpl getDao() {
		if (_dao==null) {
			_dao = (PrestationcategorieDaoCgImpl)persistence.GeneratorRuntime.getGeneratorRuntime().getImplementation(persistence.beans.dao.IPrestationcategorieDao.class);
		}
		return _dao;
	}
	...
	public boolean equals(Object obj) {
		...
		return (obj!=null) && obj.getClass()==getClass() && ((persistence.beans.dao.impl.cg.PrestationcategorieToCgImpl)obj).getCacheKey().equals(getCacheKey());
	}
